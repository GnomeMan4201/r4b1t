...
![r4b1t_h0l3 fresh load — the interface on startup](Screenshot from 2026-06-15 04-33-42.png)

A URL surfaces at random from the pool. You see the domain and a live preview card before you go anywhere.

![A URL surfaces: Airbus Space & Defence — geospatial products and secure connectivity. Domain and preview visible before visiting.](Screenshot from 2026-06-15 04-35-15.png)
...
![The Airbus Space & Defence site — opened in a new tab directly from the r4b1t_h0l3 interface](Screenshot from 2026-06-15 04-35-33.png)
...
![BRANCH mode active — radial tree of related domains sprouting from Airbus Space & Defence](Screenshot from 2026-06-15 04-35-43.png)
...
![BRANCH expanded — four intent labels with domain suggestions. Drill into this niche / adjacent territory / contrasting view / unexpected tangent.](Screenshot from 2026-06-15 04-35-51.png)
...
![Cesium.com surfaces — The Platform for 3D Geospatial, with a globe render in the preview card](Screenshot from 2026-06-15 04-36-00.png)

![Cesium.com opened directly — "The Platform for 3D Geospatial", part of Bentley Systems](Screenshot from 2026-06-15 04-36-16.png)

BRANCH on Cesium pulls in a different tree — cesiumjs.org, GitHub repos, video platforms, government data portals.

![BRANCH on Cesium — radial tree includes cesiumjs.org, ehupp/Predict, github.com, targun.video, uber-web/rst, nslog.gov](Screenshot from 2026-06-15 04-36-24.png)
...
| Key | Action |
|---|---|
| `Space` / `→` | New random URL |
| `Enter` | Visit current preview |
| `S` | Skip |
| `P` | Sprout / BRANCH |
| `Esc` | Close panel |
| `?` | Help |
